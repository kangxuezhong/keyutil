# keyutil
本demo基于苏州同济区块链研究院有限公司的[gmsm](https://github.com/tjfoc/gmsm) ，gmsm代码风格和crypto标准库基本相同。但其sm2不支持Hex格式密钥和C1C2C3旧加密模式，笔者已实现并推送至gmsm，但还未接受。所以暂时需要从<https://github.com/kangxuezhong/gmsm>下载主线代码并在go.mod中做如下处理：
```
require (
